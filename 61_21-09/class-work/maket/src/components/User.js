...
const User=({user})=>{
    ...
    return(
        <div className="card col-6 col-sm-4 col-md-3 text-center p-3 m-2">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="10rem" height="10rem" fill="currentColor" className="bi bi-person-fill mx-auto text-warning" viewBox="0 0 16 16">
        ...
        <div className="card-body">
            ...
            className="btn btn-warning">profile edit</Link> : 
