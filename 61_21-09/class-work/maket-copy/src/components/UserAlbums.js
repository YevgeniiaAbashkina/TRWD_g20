    ...
    return(
        <div className="col-8 p-3 my-2">
            ...
            <div className ='row row-cols-1 row-cols-md-3 g-4 p-2'>
                {userAlbums.map(album=> <UsAlbum key={album.id} album={album} setCurrentAlbum={setCurrentAlbum} />)}
            </div>
                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        <div className="modal-header">
                            ...
                            onClick={()=>{setAlbum({...album, title:"", cover:""})}}></button>
                        </div>
...
//console.log(true && 5 && 0 && "one") -доходит до первого фолс, если не встретится то до последнего тру

//console.log(true || 5 && 0 || "one") -доходит до первого true