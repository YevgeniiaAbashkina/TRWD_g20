/* Task01
   ...
   [2,0,0,1,1,2] -> [2,0,1]
 */
const doubleArray1_1 = [2,5,7,9,7,2];
const doubleArray1_2 = [2,0,0,1,1,2];

console.log("task1_1 = " + removeDoubleNum(doubleArray1_1));
console.log("task1_2 = " + removeDoubleNum(doubleArray1_2));


function removeDoubleNum(arr) {
  const uniqueArray = [];
...
const arrayForTask2_1 = [1,5,6,7,2];
const arrayForTask2_2 = [7,3,8,4];
console.log("task2_1 = " + getStrangeArray(arrayForTask2_1));
console.log("task2_2 = " + getStrangeArray(arrayForTask2_2));

function getStrangeArray(array) {
  if (array[0] > array[array.length-1]) {
    array.fill(array[0],0);
  } else {
    array.fill(array[array.length-1],0);
  }
  return array;
}
